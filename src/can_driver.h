...
struct struct_s_BOARD {
  int busname;  /**< The bus name on which the CAN board is connected */
  unsigned long baudrate; /**< The board baudrate */
};

#ifndef DLL_CALL
#if !defined(WIN32) || defined(__CYGWIN__) || defined(__MINGW32__) || defined(DMP_DOS_DJGPP)
#define LIBAPI
